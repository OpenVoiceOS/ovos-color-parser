# -*- coding: utf-8 -*-
"""Behaviour test for the Galician (gl-ES) colour locale."""
import unittest

from ovos_color_parser import color_from_description


class TestGalicianColors(unittest.TestCase):
    LANG = "gl"

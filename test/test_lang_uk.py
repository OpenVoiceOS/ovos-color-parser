# -*- coding: utf-8 -*-
"""Behaviour test for the Ukrainian (uk-UA) colour locale."""
import unittest

from ovos_color_parser import color_from_description


class TestUkrainianColors(unittest.TestCase):
    LANG = "uk"
